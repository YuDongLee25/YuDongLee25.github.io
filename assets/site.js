(function () {
  ...
  const zhTranslations = {
    ...
    "#pudu-internship .role + p": "参与 D5-W 四轮足机器人的 PPO 感知运动开发，包括 Isaac Gym 环境与控制适配、Teacher–Student 特权学习与策略蒸馏，以及融合深度视觉和本体感知的 PIE 部署；完成 Isaac Gym 到 MuJoCo 的 Sim-to-Sim 评估和真机 Sim-to-Real 部署，后续探索 PUMA、DreamWaQ++ 及真实场景重建。",
