(function () {
  ...
  const zhTranslations = {
    ...
    ".profile-copy > p:nth-of-type(2)": "我目前是南方科技大学智能制造与机器人专业硕士研究生，本科就读于华南农业大学自动化专业。研究方向主要是机器人轨迹规划、运动控制和具身智能，做过腿足机器人语义目标探索、跨构型机械臂生成式轨迹规划，以及基于强化学习和模型预测控制的双足机器人运动控制。在这些工作中，我主要负责算法设计与实现、仿真验证、系统集成和实机调试。",
    ".profile-links a[href^='mailto:']": "邮箱",
    ".profile-links a[data-cv-link]": "简历",
    "#interests-title": "研究兴趣",
    "#interests > p": "我的研究兴趣包括机器人轨迹规划与运动控制、机器人学习、具身导航与具身操作，以及嵌入式机器人系统。我有较丰富的机器人仿真、系统集成和实机调试经验。",
    ...
    ".expertise-item:nth-child(3) p": "使用 ROS/ROS2、NVIDIA Isaac Sim、Isaac Gym、MuJoCo 和 Webots，完成过机械臂、双足和四足机器人的仿真与实机验证。",
    ...
    ".publication-item .venue": "<em>IEEE/RSJ International Conference on Intelligent Robots and Systems (IROS)</em>，2026，已录用。*共同一作。",
    ...
    "#semantic-exploration .research-summary": "主要研究开放环境中的腿足机器人如何根据自然语言指令和不确定的语义观测选择目标并规划路径。方法包括置信度校准的语义感知、受控增长的语义拓扑记忆、基于效用的子目标选择、局部规划和强化学习运动控制。我作为共同一作，参与了语义感知、拓扑记忆和规划模块的设计与集成，并在 NVIDIA Isaac Sim 和 Unitree Go1 实机上完成闭环验证。",
    ...
    "#gnn-diffusion .research-summary": "面向不同构型的机械臂，我将 URDF 转换为图结构，用 GNN 编码机器人形态，以此作为条件，并基于 Diffusion Model 生成关节空间的 B-spline 轨迹，同时加入可微运动学约束。针对末端残差、目标更新、关节限位和奇异位形，我实现了 MPPI-MPC 末端误差滚动恢复模块。我负责图表示、轨迹生成、约束集成和恢复模块，并在 NVIDIA Isaac Sim 中验证了五种机械臂构型，随后在 KD7 和 A10 实机上完成部署测试。实验包括跨构型轨迹生成、抓取位姿到达、动态目标跟踪和末端误差恢复。",
    "#ppo-biped h3": "基于 PPO 的双足运动控制与 Sim-to-Real 评估",
    "#ppo-biped .research-summary": "使用 Isaac Gym 和 PPO 训练点足双足机器人的运动策略。课程学习逐步增加指令和地形难度，动力学随机化覆盖质量、摩擦、阻尼和观测扰动。我负责训练流程、奖励函数和课程学习模块，完成 MuJoCo Sim-to-Sim 验证，并参与 TRON2 实机部署和调试。",
    "#biped-mpc h3": "双足行走的质心动力学 MPC",
    "#biped-mpc .research-summary": "本科毕业设计采用简化质心动力学模型实现双足行走控制。接触力和力矩优化采用带约束的 MPC-QP，并考虑摩擦和法向力限制，再与摆动腿笛卡尔空间 PD 控制结合。我完成了优化与控制流程，并在 MATLAB/Simulink 和 MuJoCo 中进行了行走测试。",
    "#gimbal-project h3": "三轴自稳云台",
    "#gimbal-project .research-meta": "2022 年 5 月–2023 年 11 月",
    "#gimbal-project .role": "嵌入式系统负责人",
    "#gimbal-project .research-summary": "使用 STM32 和 FreeRTOS 开发三轴自稳云台样机，负责 IMU 状态估计、Kalman 滤波、系统辨识、串级 PID 控制和样机闭环测试。",
    ...
    "#robomaster-project .research-summary": "负责 RoboMaster 哨兵和步兵机器人的嵌入式控制开发，包括云台与底盘控制、功率管理、CAN/UART/SPI 通信、裁判系统解析、故障检测和整机联调。",
    "#experience-title": "实习经历",
    ".timeline-item:nth-child(1) h3": "香港科技大学（广州）",
    ".timeline-item:nth-child(1) .role": "科研实习生",
    ".timeline-item:nth-child(1) .role + p": "参与腿足机器人语义目标探索与具身导航研究，主要负责置信度感知的语义决策、拓扑表示和局部规划，并在 Isaac Sim 和 Unitree Go1 上进行闭环验证。相关论文被 IROS 2026 录用，共同一作。",
    ".timeline-item:nth-child(2) h3": "智元机器人（AgiBot）",
    ".timeline-item:nth-child(2) .role": "感知与规划算法实习生",
    ".timeline-item:nth-child(2) .role + p": "参与四足机器人的多传感器感知与规划开发，包括点云处理、目标检测、语义分割、目标跟踪与预测、语义导航，以及 Isaac Sim 仿真和实机测试。",
    ".timeline-item:nth-child(3) h3": "DJI 大疆创新",
    ".timeline-item:nth-child(3) .role": "电源控制算法实习生",
    ".timeline-item:nth-child(3) .role + p": "参与 24 V/40 A 双向超级电容数字电源开发，包括 ADC 采样与滤波、Buck-Boost 双闭环控制、PWM 调节、保护逻辑及整板联合调试。",
